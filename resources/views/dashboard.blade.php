<x-layouts::app :title="__('Dashboard')">
    <div class="pitmetric-app flex h-full w-full flex-1 flex-col gap-6 rounded-xl">
        <section class="overflow-hidden rounded-3xl border border-pm-border bg-pm-surface">
        ...
        <section class="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            @foreach ([
                ...
                <article class="rounded-2xl border border-pm-border bg-pm-surface p-5">
        ...
        <section class="grid gap-4 lg:grid-cols-[1fr_.8fr]">
            <article class="rounded-2xl border border-pm-border bg-pm-surface p-6 sm:p-7">
