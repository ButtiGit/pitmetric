    ...
    <div class="pitmetric-app min-h-full w-full bg-pm-page px-4 py-5 sm:px-6 lg:px-8 lg:py-7">
        <div class="mx-auto w-full max-w-[1360px] space-y-5">
            <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                ...
                <x-crud-modal id="create-configuration" :title="$it ? 'Nuova configurazione' : 'New configuration'" :description="$it ? 'Scegli mezzo e componenti solo quando devi creare una build. Puoi anche registrare il costo del lavoro.' : 'Choose vehicle and components only when creating a build. You can also record the work cost.'" :trigger="$it ? '+ Nuova configurazione' : '+ New configuration'">
