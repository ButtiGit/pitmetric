...
<x-pitmetric.record-delete :action="route('events.entries.destroy', $entry)"  />
</div>
...
<x-pitmetric.record-delete :action="route('events.tasks.destroy', $task)"  />
...
<x-pitmetric.record-delete :action="route('events.notes.destroy', $note)"  />
</div></div>@empty<p class="text-sm text-pm-muted">{{ $it ? 'Nessuna nota.' : 'No notes yet.' }}</p>@endforelse</div>
                    </section>
